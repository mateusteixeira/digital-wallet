...
class DepositValidatorTest {
    ...
    private final DepositValidator depositValidator = new DepositValidator();

    @Test
    public void should_throw_exception_when_amount_less_than_zero() {
        assertThrows(AmountBusinessException.class, () ->
                depositValidator.validateDeposit(new BigDecimal("-1")));
    }

    @Test
    public void should_throw_exception_when_amount_equal_zero() {
        assertThrows(AmountBusinessException.class, () ->
                depositValidator.validateDeposit(BigDecimal.ZERO));
    }

    @Test
    public void should_throw_exception_when_amount_greater_than_zero() {
        assertDoesNotThrow(() -> depositValidator.validateDeposit(BigDecimal.ONE));
    }
